...
import { clearWorkflowWatchers, waitForWorkflowNodeReady } from './workflow-execution-helpers'
...
export const useWorkflowOrchestrator = () => {
  ...
  const waitForNodeReady = (nodeId: string) => (
    waitForWorkflowNodeReady(nodeId, activeWatchers)
  )
